...
We use the following benchmark knowledge graphs: Wordnet - a lexical database for English, it is a taxonomy with hypernyms (is-a) relationships, and synonym sets. Wordnet contains 38,696 entities and 11 relations.  \newline
...
\begin{figure}[H]
   \caption{Wordnet Property Counts}
   \centering
    	\includegraphics[width=0.5\textwidth]{Wordnet_Counts}
\end{figure}
