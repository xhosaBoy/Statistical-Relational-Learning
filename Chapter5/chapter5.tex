...
\begin{figure}[H]
	\parbox{.5\linewidth}{
   		\caption{Wordnet Predicate Counts}
   		\centering
		% \includegraphics[width=0.45\textwidth]{Wordnet_Predicate_Counts}
    		\includegraphics[width=0.45\textwidth, height=0.2\textheight]{Wordnet_Predicate_Counts}
		}
	\hfill
	\parbox{.5\linewidth}{
		\caption{Freebase Predicate Counts}
   		\centering
    		% \includegraphics[width=0.45\textwidth]{Freebase_Predicate_Counts}
