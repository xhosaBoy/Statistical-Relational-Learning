...
\noindent The model was trained on Google Cloud Platform, on an N1 series instance with  8 CPU cores, 30GB RAM, 512GB SSD and an Nvidia Tesla P100 GPU. We evaluate the model using the standard link prediction benchmarks discussed above. \par 
