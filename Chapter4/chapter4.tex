...
\begin{figure}[H]
	...
	\captionsetup{justification=centering}
	\caption{WN18RR Hit@ 1 Predicate Performance. The relation predication performance of the HypER+ model with pre-trained embeddings. The model performs well with synonym relation types, however performs poorly with compositional and hierarchical relations.}
\end{figure}
