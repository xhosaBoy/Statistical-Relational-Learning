...
\textbf{NTN with optimised training algorithm.} We attempt a simple improvement in the NTN model by appplying training alogirthm optimisation techniques including early stopping, the Adam optimiser and hyperparameter random search. The results indicate that there are potential performance gains through simple training algorithm component substitutions. In this instance, we see an accuracy gain of 6.2\%, for the WordNet and Freebase datasets. \par
