...
\begin{figure}[H]
	...
	\captionsetup{justification=centering}
	\caption{Freebase facts structured as a KG. Due to the size of Freebase, a subset of facts is presented, where "Michael Jackson" is the subject.}
\end{figure}
