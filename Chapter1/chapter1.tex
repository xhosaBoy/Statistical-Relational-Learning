...
%********************************** %First Section  **************************************
\section{Statistical Relational Learning} %Section - 1.1 
\subsection{Artificial General Intelligence} % Artificial general intelligence 
...
\subsection{General Question Answering} % General question answering (Problem statement & Identification of desired outcome)
...
\subsection{Applications of General Question Answering} % Applications of GQA (Intelligent Virtual Assistants and GQA computer systems)
Intelligent virtual assistants (IVA) such as Alexa, Cortana, Google Assistant and Siri are mobile application attempts at AGI; Watson, Wolfram Alpha and Knowledge Engine are other GQA computer systems. So often a user will ask one of these systems a question which results in a search engine lookup, due to failure in comprehending the question and the capability of providing a coherent response.
\subsection{General Question Answering Approaches} % Potential Solutions to GQA (Reinforcement Learning and Knowledge representation and reasoning)
Reinforcement learning. Will not be covered in this dissertation....
...
\subsection{Uncertainty in Knowledge Representations}% Uncertainty in knowledge representations (Statistical Relational Learning)
...
Link prediction .... Entity-resolution ..., Link-based clustering ... % How can we use all these to answer general questions and generate new knowledge?
