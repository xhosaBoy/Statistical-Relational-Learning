...
\noindent In \textbf{Chapter 2} we discuss training algorithm approaches based on the supervised learning paradigm. We then discuss deep learning models, specifically in relation to convolutional and recurrent networks.\ We provide mathematical definitions for the models, and discuss the primary problems they aim to address, as well as examples of applications.\ We present regularisation techniques used to address overfitting, namely early stopping, dropout \unskip ~\citep{srivastava2014dropout} and batch normalisation. Finally we discuss language models and their utility in semantic representations. \par
