	...
	\For{Epoch $ k =  1 \dots \; K $}{
		\For{Mini-batch b = 1 \dots B} {
	 		...
	 		\For{(x, y) $ \in S $}{
				...
				$ l \gets loss(y - y^{'}) $ // compute loss e.g. cross-entropy or squared difference \\
...
\noindent In the following paragraphs we discuss the CN forward pass. \par
